...
//@Entity
//@Cacheable(true)
//@Table(name="logi_mtc_cust")
//@XmlRootElement
public class LogisticaMatrizTempoCoberturaCusto extends RegistroBase implements Serializable {
    private static final long serialVersionUID = 3214125134511L;
    private Long id;
    ...
    public BigDecimal getValorCurva(String curva){
        ...
        for(LogisticaMatrizTempoCoberturaValor valor : this.valores){
    ...
    public boolean equals(Object obj) {
        ...
        final LogisticaMatrizTempoCoberturaCusto other = (LogisticaMatrizTempoCoberturaCusto) obj;
    ...
    public String toString() {
        return "LogistricaMatrizTempoCoberturaValor[id=" + id + ", custo='" + custo + "']";
    }
